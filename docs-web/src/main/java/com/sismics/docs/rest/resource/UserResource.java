...
public class UserResource extends BaseResource {
    ...
    public Response register(
        ...
        mobile = ValidationUtil.validateLength(mobile, "mobile", 1, 100);
    ...
    public Response update(
        ...
        password = ValidationUtil.validateLength(password, "password", 8, 50, true);
        email = ValidationUtil.validateLength(email, "email", 1, 100, true);
        mobile = ValidationUtil.validateLength(mobile, "mobile", 1, 100, true);
     ...
     * @apiSuccess {String} user.mobile Mobile (in String)
     * @apiError (client) ForbiddenError Access denied
     * @apiError (client) UserNotFound The user does not exist
     * @apiPermission user
     * @apiVersion 1.5.1
    ...
    public Response list(
        ...
        for (UserDto userDto : userDtoList) {
            users.add(Json.createObjectBuilder()
                    ...
                    .add("mobile", userDto.getMobile() != null));
        }
