...
public final class EMF {
    ...
    private static Map<Object, Object> getEntityManagerProperties() {
        ...
        String databaseUrl = "jdbc:postgresql://localhost:5432/db_idoc2";
        String databaseUsername = "dumindudsh";
        String databasePassword = "";

        // String databaseUrl = "jdbc:mysql://localhost:3306/db_idoc?createDatabaseIfNotExist=true&useUnicode=true&characterEncoding=UTF-8&useSSL=false";
